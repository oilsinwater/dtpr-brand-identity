...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function vc(e,t,n){let r=new Float32Array(ic),i=new q(0,1,0);return new Ao({name:`SphericalGaussianBlur`,defines:{n:ic,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:xc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function yc(){return new Ao({name:`EquirectangularToCubeUV`,uniforms:{envMap:{value:null}},vertexShader:xc(),fragmentShader:`
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function bc(){return new Ao({name:`CubemapToCubeUV`,uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:xc(),fragmentShader:`
	...
	`}var Sc=class extends $t{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new Gi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
...
`,transparent:!0,depthTest:!1,depthWrite:!1,blending:f.additive?2:1,uniforms:{uTime:{value:0},uAspect:{value:1},uPointer:{value:new K},uPointerStrength:{value:0},uCursor:{value:p.cursor},uScale:{value:p.scale},uWarp:{value:p.warp},uContrast:{value:f.contrast},uOpacity:{value:f.opacity},uCentre:{value:Array.from({length:3},()=>new K)},uRadius:{value:Array.from({length:3},()=>new K(1,1))},uColor:{value:Array.from({length:3},()=>new Z)},uAmp:{value:[,,,].fill(0)},uPhase:{value:Array.from({length:3},(e,t)=>t*17.3)}}}),x=new ii(new go(2,2),b),v.add(x),ae(),C=performance.now(),se()}}function ae(){let e=m.value;!e||!_||(M=e.clientWidth||1,N=e.clientHeight||1,j=e.getBoundingClientRect(),_.setSize(M,N,!1),b.uniforms.uAspect.value=M/N,oe(),ce())}function oe(){let e=b.uniforms,t=e.uAspect.value,n=M<700?.55:1;e.uOpacity.value=f.opacity*n,e.uContrast.value=f.contrast,e.uScale.value=p.scale,e.uWarp.value=p.warp,e.uCursor.value=p.cursor;for(let n=0;n<3;n++){let r=f.blobs[n];if(!r){e.uAmp.value[n]=0;continue}e.uAmp.value[n]=r.amp,e.uCentre.value[n].set((r.x-.5)*2*t,-(r.y-.5)*2),e.uRadius.value[n].set(Math.max(r.rx*2*t,.05),Math.max(r.ry*2,.05)),e.uColor.value[n].set(re.set(r.color))}}function se(){if(S=requestAnimationFrame(se),!_||!O||!k)return;let e=performance.now();e-w<xd||(w=e,oe(),P.lerp(ee,.09),ne+=(te-ne)*.07,b.uniforms.uPointer.value.copy(P),b.uniforms.uPointerStrength.value=ne,A||(b.uniforms.uTime.value=(e-C)/1e3*p.speed),ce())}function ce(){_&&_.render(v,y)}function F(e){if(A||!j||!O)return;let t=(e.clientX-j.left)/j.width,n=(e.clientY-j.top)/j.height,r=b.uniforms.uAspect.value;ee.set((t-.5)*2*r,-(n-.5)*2);let i=Math.max(0,Math.max(-n,n-1,-t,t-1));te=Math.max(0,1-i*4)}function I(){te=0}function le(){m.value&&(j=m.value.getBoundingClientRect())}function ue(){k=document.visibilityState===`visible`}function de(e){A=e.matches,A&&(te=0,ee.set(0,0))}return e(()=>f.additive,e=>{b&&(b.blending=e?2:1,b.needsUpdate=!0)}),i(()=>{D=window.matchMedia(`(prefers-reduced-motion: reduce)`),A=D.matches,D.addEventListener(`change`,de),ie(),!g.value&&(T=new ResizeObserver(ae),T.observe(m.value),E=new IntersectionObserver(([e])=>{O=e.isIntersecting,O&&(j=m.value?.getBoundingClientRect()??j)},{threshold:0}),E.observe(m.value),window.addEventListener(`pointermove`,F,{passive:!0}),document.addEventListener(`pointerleave`,I),window.addEventListener(`scroll`,le,{passive:!0}),document.addEventListener(`visibilitychange`,ue))}),o(()=>{S&&cancelAnimationFrame(S),T?.disconnect(),E?.disconnect(),D?.removeEventListener(`change`,de),window.removeEventListener(`pointermove`,F),document.removeEventListener(`pointerleave`,I),window.removeEventListener(`scroll`,le),document.removeEventListener(`visibilitychange`,ue),x?.geometry.dispose(),b?.dispose(),_?.dispose(),_=null}),(e,i)=>(s(),r(`div`,{ref_key:`containerRef`,ref:m,class:`absolute inset-0 overflow-hidden pointer-events-none`,"aria-hidden":`true`},[t(n(`canvas`,{ref_key:`canvasRef`,ref:h,class:`block w-full h-full`},null,512),[[l,!g.value]])],512))}};export{Ao as $,Hs as A,Mo as B,br as C,gi as D,As as E,v as F,go as G,ls as H,Nt as I,Pt as J,Ui as K,X as L,Fo as M,Li as N,Fr as O,g as P,Rn as Q,ii as R,po as S,ps as T,Da as U,kn as V,cs as W,u as X,Ms as Y,_o as Z,Z as _,_d as a,K as at,Xe as b,od as c,$t as ct,Xi as d,Oa as et,_r as f,d as g,sa as h,md as i,Do as it,Ti as j,Ni as k,fs as l,bo as lt,Ki as m,ud as n,vo as nt,qs as o,q as ot,Mr as p,Ri as q,vd as r,yo as rt,$ as s,Zt as st,Sd as t,wr as tt,$n as u,Zi as v,An as w,$i as x,ds as y,Kr as z};